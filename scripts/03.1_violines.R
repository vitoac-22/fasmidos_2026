...
figura_paper <- ggplot(df_long, aes(x = exito_eclosion, y = medida, fill = exito_eclosion)) +
  ...
  theme(
    ...
    # Estilizado de títulos para que no parezcan de PowerPoint básico
...
print(figura_paper)
ggsave("figura_01_violines.tiff",
       plot = figura_paper, width = 8.5, height = 5.5, dpi = 300, compression = "lzw"
       ,path = "pics")
